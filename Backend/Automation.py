...
from AppOpener import close, open as appopen # Import functionns to open and close apps.
...
import subprocess # Import subprocess for loceraching with the system.
...
# Define CSS classes for parsing specific eliments in HTML content.
...
async def TranslateAndExecute(commands: list[str]):
    ...
    funcs = [] # List to hold asynchronous tasks.
...
if __name__ == "__main__":
    asyncio.run(Automation(["search on google instagram", "play despacito on youtube", "content write a poem on nature", "google search what is IYMC", "youtube search cute life run bts", "search on google facebook"])) 
