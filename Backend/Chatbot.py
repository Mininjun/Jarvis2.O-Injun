...
# Retrieve specific environment variables for username, assistant name, and APIkey.
...
# Define the system message that provides context to the AI chatbot about its role and behavior.
...
# Function to modify the chatbot's response for betetr formatting.
...
def ChatBot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            model="compound-beta-mini", # Specify the AI model to use.
        ...
        # Hnadle errors by printing the exception and resetting the chat log.
        print(f"Error {e}")
        with open(r"Data\ChatLog.json", "w") as f:
            dump([], f, indent=4)
...
if __name__ == "__main__":
    while True:
        user_input = input("Enter Your Question: ") # Print the user for a question.
