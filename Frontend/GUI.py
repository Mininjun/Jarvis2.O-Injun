from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QLineEdit, QGridLayout, QVBoxLayout, QHBoxLayout, QLayout, QPushButton, QFrame, QLabel, QSizePolicy
...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        self.gif_label.setAlignment(Qt.Alignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignBottom))
